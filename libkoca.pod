...
B<string> is a an arbitrary string you want to put after the progress bar. This can contain unicode symbols. But in that case the string will not take the full space. If term width is too small, B<string> will be truncated. 
