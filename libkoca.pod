...
=head1 SYNOPSIS
    ...
    bash libkoca.sh help
    bash libkoca.sh list
    bash libkoca.sh version
...
Please note that is speed is too fast, or string or file to display too long, or computer too slow time take to display could be longer. For example C<koca_banner @/etc/hosts 1> will not take 1s.
...
B<string> is a an arbitrary string you want to put after the progress bar.
...
10%  [######______________|__________/__________|_____________________]ETA: 10s
...
'n' is the spin type, from 0 to 4, included. 0 by default, or if n is greater than 4.
...
One breath last 12 or 15s. To make things pleasant you can setup the sleep to make a spin cycle last that duration.

Here are the according sleep:

	0 : /-\|/-\| : length: 8.	12=>5/8=0.625s, 15=>4/8=0.5s
	1 : |>=<|<=> : length: 8.	12=>5/8=0.625s, 15=>4/8=0.5s
	2 : Oo.o : length: 4.		12=>5/4=1.25s, 15=>4/4=1s
	3 : [{(|)}] : length: 7		12=>5/7=0.7s, 15=>4/7=0.6s
	4 : .oOo : length: 4		12=>5/4=1.25s, 15=>4/4=1s
